...
Las técnicas que se emplean en conjunto con la extracción de características son las siguientes:
   ...
   * Pruning. Este método es empleado para la eliminación de elementos de imagen excedentes producto del empleo de :math:`s_k`eletons y thinning.
...
En otro trabajo como en el propuesto en :cite:`antecedentesReconstruccion3Dnro2`, Sudáfrica. En el cual se diseñaría un sistema automatizado de detección y análisis de fallas en los circuitos viales utilizando un dispositvo de bajo costo como el sensor Kinect montado sobre un vehículo.
