...
..  Dado que la velocidad de la luz en la atmósfera *c* es una constante que se conoce, solamente se debe calcular el tiempo de viaje y de retorno *t*, por lo que la precisión con la que un láser ToF detecta un objeto, depende en gran medida de la precisión respecto de la medición del tiempo.Por lo tanto, la detección de este tipo de dispositivos consiste en emitir varios rayos de luz sobre un objeto y en base a éstos, computar las distancias a partir de las cuales se computarán las coordenadas de los puntos.
