...
Alternativamente, se pueden emplear diagramas de dispersión (scatter plots), donde se grafican los valores de dos features, agregando un punto por cada instancia, lo que permite revelar si existe algun tipo de relación útil (linear o no) entre features, para el entrenamiento modelo. 
