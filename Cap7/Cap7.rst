...
Adicionalmente, se ha estudiado los distintos tipos de descriptores que ofrece PCL teniendo en cuenta las características propias de cada uno y su contribución al proceso de clasificación de las fallas viales, exponiendo en detalle aquellos que mejor representaban la forma objeto en estudio.
...
Por otro lado, la aplicación de captura puede ser extendida para soportar diferentes tipos de sensores tridimensionales que empleen distintos tipos de formato, realizando para esto una comprobación al inicio para identificar el tipo de dispositivo actualmente conectado. 
